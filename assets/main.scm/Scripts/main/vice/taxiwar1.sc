...
//LOAD_MISSION_AUDIO 1 TAX1_1 // REPLACED OPCODE
//LOAD_MISSION_AUDIO 2 TAX1_2 ?/ REPLACED OPCODE
...
REQUEST_MODEL taxi
REQUEST_MODEL wmycd1
REQUEST_MODEL bmocd
REQUEST_MODEL kaufman

	WHILE NOT HAS_MODEL_LOADED taxi
	OR NOT HAS_MODEL_LOADED wmycd1
	OR NOT HAS_MODEL_LOADED	bmocd
...
ADD_BLIP_FOR_COORD 7673.6630 -8730.4750 6.0467 blip1_taxicab1
...
IF IS_CHAR_IN_ANY_CAR scplayer
	STORE_CAR_CHAR_IS_IN_NO_SAVE scplayer players_cab
ENDIF
...
WHILE NOT LOCATE_CHAR_ANY_MEANS_3D scplayer 7673.6630 -8730.4750 6.0467 2.5 2.5 3.0 TRUE 
OR NOT IS_CHAR_IN_MODEL scplayer kaufman
OR IS_PLAYER_PRESSING_HORN player1
	WAIT 0
		...
		IF IS_CHAR_IN_MODEL scplayer kaufman 
			STORE_CAR_CHAR_IS_IN_NO_SAVE scplayer players_cab
		ELSE
		...
		IF LOCATE_STOPPED_CHAR_ANY_MEANS_3D scplayer -576.7 -480.1 11.0 2.5 2.5 3.0 TRUE
		AND IS_CHAR_IN_MODEL scplayer kaufman
...
CREATE_CHAR PEDTYPE_CIVMALE bmocd -573.9 -448.1 14.1 theVIP
SET_CHAR_HEADING theVIP 270.0
CLEAR_CHAR_TASKS theVIP
LOCATE_STOPPED_CHAR_ON_FOOT_2D theVIP -564.3 -447.9 1.5 1.5 FALSE // REPLACED OPCODE

//SET_FIXED_CAMERA_POSITION -576.171 -461.122 11.516 0.0 0.0 0.0 //Watching VIP walk from mansion
SET_FIXED_CAMERA_POSITION 7673.6630 -8730.4750 6.0467 0.0 0.0 0.0 //Watching VIP walk from mansion
//POINT_CAMERA_AT_POINT -575.533 -460.370 11.682 JUMP_CUT
POINT_CAMERA_AT_POINT 7672.6930 -8731.4750 6.0633 JUMP_CUT

// LOAD_MISSION_AUDIO 1 TAX1_3 // REPLACED OPCODE
...
CREATE_CHAR_INSIDE_CAR eviltaxi PEDTYPE_CIVMALE wmycd1 taximan1
...
//SET_CHAR_PERSONALITY taximan1 PEDSTAT_TOUGH_GUY // REPLACED OPCODE
...
IF NOT IS_CHAR_DEAD theVIP
	...
	TASK_ENTER_CAR_AS_PASSENGER theVIP eviltaxi 10000 0
...
//SET_CHAR_FRIGHTENED_IN_JACKED_CAR theVIP TRUE // REPLACED OPCODE

ADD_BLIP_FOR_COORD -1438.1 -833.6 11.3 blip1_taxicab1


// LOAD_MISSION_AUDIO 1 TAX1_4 // REPLACED OPCODE
...
WHILE NOT LOCATE_STOPPED_CHAR_ANY_MEANS_3D theVIP -1438.1 -833.6 11.3 5.0 5.0 5.0 TRUE 
	WAIT 0
		...
		IF NOT IS_CAR_DEAD eviltaxi
			IF NOT IS_CHAR_IN_CAR	scplayer eviltaxi
		...
		IF NOT IS_CAR_DEAD eviltaxi
			...
			OR IS_CHAR_DEAD taximan1
				IF got_into_players_taxi = 0 
					...
					IF NOT IS_CHAR_DEAD	theVIP
		//				SET_CHAR_FRIGHTENED_IN_JACKED_CAR theVIP FALSE // REPLACED OPCODE
					ENDIF
					...
					IF NOT IS_CHAR_DEAD	theVIP
						//LOAD_MISSION_AUDIO 2 TAX1_5 // REPLACED OPCODE
						CLEAR_CHAR_TASKS theVIP // REPLACED OPCODE
						//SET_CHAR_RUNNING theVIP TRUE // RREPLACED OPCODE
						//SET_CHAR_AS_LEADER theVIP player1 // REPLACED OPCODE
					ENDIF 
		...
		IF got_into_players_taxi = 1
			...
			IF played_taxiwar1_samp = 0
				IF NOT IS_CHAR_DEAD theVIP
					IF LOCATE_CHAR_ANY_MEANS_CHAR_3D scplayer theVIP 15.0 15.0 6.0 FALSE
						IF TIMERB > 2000
...
IF NOT IS_CAR_DEAD players_cab
	IF NOT IS_CHAR_DEAD	theVIP
		...
		AND NOT LOCATE_STOPPED_CHAR_ANY_MEANS_3D scplayer -1438.1 -833.6 11.3 5.0 5.0 5.0 TRUE
			PRINT_NOW ( TAXW1_4 ) 5000 1  //The V.I.P. has been dropped off!
			GOTO mission_taxiwar1_failed
		ENDIF
	ENDIF
...
IF NOT IS_CAR_DEAD players_cab
	IF NOT IS_CHAR_DEAD	theVIP
		//IF IS_CHAR_IN_CAR theVIP players_cab
		//AND LOCATE_STOPPED_CHAR_ANY_MEANS_3D players_cab -1438.1 -833.6 11.3 5.0 5.0 5.0 TRUE
			SET_PLAYER_CONTROL player1 OFF
			SWITCH_WIDESCREEN ON
			...
			IF NOT IS_CHAR_DEAD	theVIP
				REMOVE_CHAR_FROM_GROUP	 theVIP // REPLACED OPCODE
			//	SET_CHAR_RUNNING theVIP FALSE // REPLACED OPCODE
				WARP_CHAR_FROM_CAR_TO_COORD theVIP -1459.6 -825.3 13.9
				SET_CHAR_HEADING theVIP 146.0
				LOCATE_STOPPED_CHAR_ON_FOOT_2D theVIP -1465.7 -832.2 1.5 1.5 FALSE // REPLACED OPCODE
			ENDIF
			WAIT 3500
			RESTORE_CAMERA_JUMPCUT
...
IF NOT IS_CHAR_DEAD	theVIP
	...
	//AND LOCATE_CHAR_ON_FOOT_3D player1 -1438.1 -833.6 11.3 5.0 5.0 5.0 TRUE
		SET_PLAYER_CONTROL player1 OFF
		SWITCH_WIDESCREEN ON
		SET_FIXED_CAMERA_POSITION -1462.635 -791.768 15.662 0.0 0.0 0.0 //Look at airport
		POINT_CAMERA_AT_POINT -1462.162 -792.641 15.783 JUMP_CUT
		...
		POINT_CAMERA_AT_POINT -1467.827 -833.977 16.091 JUMP_CUT
		IF NOT IS_CHAR_DEAD	theVIP
			REMOVE_CHAR_FROM_GROUP theVIP
			// SET_CHAR_RUNNING theVIP FALSE // REMOVED OPCODE
...
MARK_MODEL_AS_NO_LONGER_NEEDED wmycd1
MARK_MODEL_AS_NO_LONGER_NEEDED bmocd
