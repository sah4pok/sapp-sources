	...
	IF flag_player_on_mission = 0
		...
		IF IS_PLAYER_PLAYING player1
			...
			IF IS_CHAR_IN_MODEL scplayer KAUFMAN
			    IF NOT LOCATE_CHAR_ANY_MEANS_3D scplayer taxiwarX taxiwarY taxiwarZ 3.0 3.0 3.0 FALSE //KAUFMAN PARK
...
/*
						...
						WAIT mission_trigger_wait_time
							...
							IF IS_PLAYER_PLAYING player1
								IF IS_CHAR_IN_MODEL scplayer kaufman
								AND LOCATE_CHAR_ANY_MEANS_3D scplayer taxiwarX taxiwarY taxiwarZ 3.0 3.0 3.0 FALSE //KAUFMAN PARK
									IF flag_player_on_mission = 0
										IF CAN_PLAYER_START_MISSION player1
										//	been_in_a_taxi_before = 1
											//GOSUB taxiwar_script_cut // CUTSCENE LOADING
										...
										WHILE LOCATE_CHAR_IN_CAR_3D scplayer taxiwarX taxiwarY taxiwarZ 2.0 2.0 2.0 FALSE
											WAIT 0
								...
								IF LOCATE_CHAR_ON_FOOT_3D scplayer taxiwarX taxiwarY taxiwarZ 1.0 2.0 2.0 FALSE
