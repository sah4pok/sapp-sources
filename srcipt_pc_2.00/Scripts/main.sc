...
//LOAD_AND_LAUNCH_MISSION main2.sc
//wait 0
LOAD_AND_LAUNCH_MISSION initial.sc
wait 0
LOAD_AND_LAUNCH_MISSION initial2.sc
//wait 0
//LOAD_AND_LAUNCH_MISSION initial3.sc
//wait 0
//LOAD_AND_LAUNCH_MISSION initial4.sc
...
VAR_INT f1_which_missions_are_open_flag bs_which_missions_are_open_flag	voice_over_at_hub airstrip_contact_blip
...
VAR_INT cat_counter funeral_mission_finished showroom_contact_blip sunshine_contact_blip
...
GOTO dont_run_the_blips
	...
	ADD_SPRITE_BLIP_FOR_CONTACT_POINT propertyX[32] propertyY[32] propertyZ[32] RADAR_SPRITE_PROPERTY_GREEN sunshine_contact_blip
	...
	CREATE_LOCKED_PROPERTY_PICKUP propertyX[32] propertyY[32] propertyZ[32] PROP_4 save_housepickup[32]	//SUNSHINE
...
// DEBUG
START_NEW_SCRIPT sunshine_buy_loop
...
// SUNSHINE AUTOS PURCHASING SCRIPT
...
save_houseprice[32] = 75000
REMOVE_PICKUP save_housepickup[32]
CREATE_FORSALE_PROPERTY_PICKUP propertyX[32] propertyY[32] propertyZ[32] save_houseprice[32] PROP_3 save_housepickup[32]


sunshine_buy_loop_inner:
	...
	IF IS_PLAYER_PLAYING player1
		IF flag_player_on_mission = 0
			//IF CAN_PLAYER_START_MISSION player1
				IF HAS_PICKUP_BEEN_COLLECTED save_housepickup[32]
					buying_property_switch = PROP_BUY32
					REPORT_MISSION_AUDIO_EVENT_AT_POSITION propertyX[32] propertyY[32] propertyZ[32] SOUND_PROPERTY_PURCHASED
					LOAD_AND_LAUNCH_MISSION buypro.sc
					TERMINATE_THIS_SCRIPT
				ENDIF
			//ENDIF
...
VAR_INT save_house_index already_bought_house[33] prorerty_switch[33]
...
VAR_INT remove_grove_pickup[19] grove_save_pickup[19] save_index created_save_blips	number_of_save_icons
VAR_FLOAT save_pickupX[19] save_pickupY[19] save_pickupZ[19] 
VAR_FLOAT save_playerX[19] save_playerY[19] save_playerZ[19] save_playerH[19]
		...
		IF flag_player_on_mission = 0
			...
			AND NOT IS_BIT_SET iDateReport DATE_IN_PROGRESS
				...
				IF created_save_blips = 0
					...
					ENDIF
					IF number_of_save_icons >= 19
						CREATE_PICKUP PICKUPSAVE PICKUP_ONCE save_pickupX[18] save_pickupY[18] save_pickupZ[18] grove_save_pickup[18] //SUNSHINE AUTOS//remove					
					ENDIF
