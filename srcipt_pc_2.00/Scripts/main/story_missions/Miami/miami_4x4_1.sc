...
STORE_CAR_CHAR_IS_IN_NO_SAVE scplayer player_4x4
...
WHILE counter_4x4_pickups < 24
	...
	IF IS_CHAR_IN_MODEL scplayer PCJ600
	OR	flag_intro < 4
		IF flag_blip_1 = 0
			DRAW_CORONA x_1 y_1 z_1 1.0 CORONATYPE_SHINYSTAR FLARETYPE_NONE 0 200 200
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_1 y_1 z_1 2.5 2.5 3.5 false
				REMOVE_BLIP blip_1
				++ counter_4x4_pickups
		...
		IF flag_blip_2 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_2 y_2 z_2 2.5 2.5 3.5 false
				REMOVE_BLIP blip_2
				++ counter_4x4_pickups
		...
		IF flag_blip_3 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_3 y_3 z_3 2.5 2.5 3.5 false
				REMOVE_BLIP blip_3
				++ counter_4x4_pickups
		...
		IF flag_blip_4 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_4 y_4 z_4 2.5 2.5 3.5 false
				REMOVE_BLIP blip_4
				++ counter_4x4_pickups
		...
		IF flag_blip_5 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_5 y_5 z_5 2.5 2.5 3.5 false
				REMOVE_BLIP blip_5
				++ counter_4x4_pickups
		...
		IF flag_blip_6 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_6 y_6 z_6 2.5 2.5 3.5 false
				REMOVE_BLIP blip_6
				++ counter_4x4_pickups
		...
		IF flag_blip_7 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_7 y_7 z_7 2.5 2.5 3.5 false
				REMOVE_BLIP blip_7
				++ counter_4x4_pickups
		...
		IF flag_blip_8 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_8 y_8 z_8 2.5 2.5 3.5 false
				REMOVE_BLIP blip_8
				++ counter_4x4_pickups
		...
		IF flag_blip_9 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_9 y_9 z_9 2.5 2.5 3.5 false
				REMOVE_BLIP blip_9
				++ counter_4x4_pickups
		...
		IF flag_blip_10 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_10 y_10 z_10 2.5 2.5 3.5 false
				REMOVE_BLIP blip_10
				++ counter_4x4_pickups
		...
		IF flag_blip_11 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_11 y_11 z_11 2.5 2.5 3.5 false
				REMOVE_BLIP blip_11
				++ counter_4x4_pickups
		...
		IF flag_blip_12 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_12 y_12 z_12 2.5 2.5 3.5 false
				REMOVE_BLIP blip_12
				++ counter_4x4_pickups
		...
		IF flag_blip_13 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_13 y_13 z_13 2.5 2.5 3.5 false
				REMOVE_BLIP blip_13
				++ counter_4x4_pickups
		...
		IF flag_blip_14 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_14 y_14 z_14 2.5 2.5 3.5 false
				REMOVE_BLIP blip_14
				++ counter_4x4_pickups
		...
		IF flag_blip_15 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_15 y_15 z_15 2.5 2.5 3.5 false
				REMOVE_BLIP blip_15
				++ counter_4x4_pickups
		...
		IF flag_blip_16 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_16 y_16 z_16 2.5 2.5 3.5 false
				REMOVE_BLIP blip_16
				++ counter_4x4_pickups
		...
		IF flag_blip_17 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_17 y_17 z_17 2.5 2.5 3.5 false
				REMOVE_BLIP blip_17
				++ counter_4x4_pickups
		...
		IF flag_blip_18 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_18 y_18 z_18 2.5 2.5 3.5 false
				REMOVE_BLIP blip_18
				++ counter_4x4_pickups
		...
		IF flag_blip_19 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_19 y_19 z_19 2.5 2.5 3.5 false
				REMOVE_BLIP blip_19
				++ counter_4x4_pickups
		...
		IF flag_blip_20 = 0
			...
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_20 y_20 z_20 2.5 2.5 3.5 false
				REMOVE_BLIP blip_20
				++ counter_4x4_pickups
		...
		IF flag_blip_21 = 0
			DRAW_CORONA x_21 y_21 z_21 1.0 CORONATYPE_SHINYSTAR FLARETYPE_NONE 0 200 200
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_21 y_21 z_21 2.5 2.5 3.5 false
				REMOVE_BLIP blip_21
				++ counter_4x4_pickups
		...
		IF flag_blip_22 = 0
			DRAW_CORONA x_22 y_22 z_22 1.0 CORONATYPE_SHINYSTAR FLARETYPE_NONE 0 200 200
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_22 y_22 z_22 2.5 2.5 3.5 false
				REMOVE_BLIP blip_22
				++ counter_4x4_pickups
		...
		IF flag_blip_23 = 0
			DRAW_CORONA x_23 y_23 z_23 1.0 CORONATYPE_SHINYSTAR FLARETYPE_NONE 0 200 200
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_23 y_23 z_23 2.5 2.5 3.5 false
				REMOVE_BLIP blip_23
				++ counter_4x4_pickups
		...
		IF flag_blip_24 = 0
			DRAW_CORONA x_24 y_24 z_24 1.0 CORONATYPE_SHINYSTAR FLARETYPE_NONE 0 200 200
			IF LOCATE_CHAR_IN_CAR_3D scplayer x_24 y_24 z_24 2.5 2.5 3.5 false
				REMOVE_BLIP blip_24
				++ counter_4x4_pickups
	...
	IF flag_truck_1 = 0
		IF LOCATE_CHAR_ANY_MEANS_2D scplayer 274.0 -905.0 10.0 10.0 FALSE //from ocean beach side
	...
	ENDIF			
	IF flag_truck_2 = 0
		IF LOCATE_CHAR_ANY_MEANS_2D scplayer 239.0 -1081.0 10.0 10.0 FALSE //from ocean beach side
	...
	IF flag_intro > 3
		IF NOT IS_CHAR_IN_MODEL scplayer PCJ600
			WHILE NOT IS_CHAR_IN_MODEL scplayer PCJ600
				WAIT 0
				IF flag_timer = 1
				...
				AND NOT IS_CHAR_IN_MODEL scplayer PCJ600
					PRINT_NOW (T4x4_F) 3000 1 		
					GOTO mission_4x4one_failed
				ENDIF
