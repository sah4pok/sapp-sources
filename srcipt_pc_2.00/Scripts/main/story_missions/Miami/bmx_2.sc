...
IF counter_bmx_2_reward	> 2
	...
	CREATE_CHAR_INSIDE_CAR blokes_car PEDTYPE_CIVMALE WMYSGRD irrate_bloke
	GIVE_WEAPON_TO_CHAR irrate_bloke WEAPONTYPE_NIGHTSTICK 0
	TASK_KILL_CHAR_ON_FOOT irrate_bloke scplayer
ENDIF
...
WHILE counter_laps < 2
	...
	IF NOT IS_CHAR_IN_MODEL scplayer landstal
