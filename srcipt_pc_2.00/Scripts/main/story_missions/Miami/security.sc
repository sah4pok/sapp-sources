...
CREATE_CHAR PEDTYPE_CIVMALE wmysgrd gate_security_1_x gate_security_1_y gate_security_1_z security_bloke1
CREATE_CHAR PEDTYPE_CIVMALE wmysgrd gate_security_1_x gate_security_1_y gate_security_1_z security_bloke2
...
security_inner:
	...
	IF IS_PLAYER_PLAYING player1
		...
		*/
		...
		IF NOT var_rampage_check = 1 
			IF sec_counter = 1
				IF IS_CHAR_IN_ZONE scplayer GOLFC
					...
					//IF LOCATE_CHAR_ANY_MEANS_3D scplayer metal_detector_x metal_detector_y metal_detector_z 35.0 35.0 35.0 FALSE
					IF LOCATE_CHAR_ANY_MEANS_3D scplayer metal_detector_x metal_detector_y metal_detector_z 8.0 8.0 3.0 FALSE

						GET_CHAR_COORDINATES scplayer zob_x zob_y zob_z
						...
						IF zob_y < metal_detector_y 
							IF flag_cam_switch = 0
								...
								// SWITCH_SECURITY_CAMERA ON // CCTV
								flag_cam_switch = 1
							ENDIF
						ENDIF
						IF zob_y > metal_detector_y 
						...
						IF LOCATE_CHAR_ANY_MEANS_3D scplayer metal_detector_x metal_detector_y metal_detector_z 1.0 1.0 1.5 FALSE
							GOSUB get_ammo
					...
					ELSE
						...
						IF NOT flag_cam_switch = 0
							GET_CHAR_HEADING scplayer player_heading
							IF flag_cam_switch = 1
								IF player_heading > 155.0
								AND player_heading < 245.0
									RESTORE_CAMERA_JUMPCUT
									//SWITCH_SECURITY_CAMERA OFF // CCTV
					...
					IF flag_goons_created = 0
						...
						IF NOT ground_z	= 0.0000
							...
							SET_CHAR_DECISION_MAKER security_bloke2 DM_PED_EMPTY
							SET_CHAR_HEADING security_bloke1 300.0
							//CHAR_SET_IDLE security_bloke1 
							SET_CHAR_STAY_IN_SAME_PLACE security_bloke1  TRUE
							
							CREATE_CHAR PEDTYPE_CIVMALE wmysgrd gate_security_2_x gate_security_2_y gate_security_2_z security_bloke2
							...
							SET_CHAR_STAY_IN_SAME_PLACE security_bloke2 TRUE
							IF flag_security_model_loaded = 0
	...
	IF IS_PLAYER_PLAYING player1
		...
		IF NOT var_rampage_check = 1 
			IF sec_counter = 2
				IF IS_CHAR_IN_ZONE scplayer A_PORT
					...
					//GOSUB pickup_check
					IF flag_player_on_bike = 1
						//SET_THREAT_FOR_PED_TYPE PEDTYPE_GANG_SECURITY THREAT_PLAYER1 // REMOVED OPCODE
	...
	AND flag_player_on_mission = 0
		IF IS_CHAR_IN_ZONE scplayer BEACH2
			IF flag_player_in_cop_shop = 1
				IF NOT IS_PLAYER_WEARING player1 player6
					IF NOT LOCATE_CHAR_ANY_MEANS_3D scplayer 392.0 -478.5 12.4 5.0 5.0 5.0 FALSE
...
kill_them_all_1:
	IF NOT IS_CHAR_DEAD security_bloke1
		IF IS_PLAYER_PLAYING player1
			TASK_KILL_CHAR_ON_FOOT security_bloke1 scplayer
			IF flag_1_tooled = 0
...
kill_them_all_2:
	IF NOT IS_CHAR_DEAD security_bloke2
		IF IS_PLAYER_PLAYING player1
			TASK_KILL_CHAR_ON_FOOT security_bloke2 scplayer
			IF flag_2_tooled = 0
