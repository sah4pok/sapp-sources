...
ammunation_cleanup_big:
	...
	//MARK_MODEL_AS_NO_LONGER_NEEDED CHROMEGUN
	//MARK_MODEL_AS_NO_LONGER_NEEDED GRENADE
	MARK_MODEL_AS_NO_LONGER_NEEDED MP5K
	MARK_MODEL_AS_NO_LONGER_NEEDED BUDDYSHOT
	//MARK_MODEL_AS_NO_LONGER_NEEDED SATCHEL
	//MARK_MODEL_AS_NO_LONGER_NEEDED BOMB
	MARK_MODEL_AS_NO_LONGER_NEEDED RUGRIFLE
	MARK_MODEL_AS_NO_LONGER_NEEDED LASER
	MARK_MODEL_AS_NO_LONGER_NEEDED RUGER
	MARK_MODEL_AS_NO_LONGER_NEEDED STEYR
	//MARK_MODEL_AS_NO_LONGER_NEEDED M4
	MARK_MODEL_AS_NO_LONGER_NEEDED MAG44
	//MARK_MODEL_AS_NO_LONGER_NEEDED SHOTGSPA
