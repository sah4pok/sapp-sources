...
LOAD_MISSION_TEXT PHIL1 // DEBUG
SET_PLAYER_GROUP_RECRUITMENT player1 FALSE
//SET_SHORTCUT_DROPOFF_POINT_FOR_MISSION -1004.5 311.1 9.9 155.7 // REMOVED OPCODE
...
REQUEST_MODEL patriotb

WHILE NOT HAS_MODEL_LOADED walton
OR NOT HAS_MODEL_LOADED WMYCR
OR NOT HAS_MODEL_LOADED faggio
OR NOT HAS_MODEL_LOADED cj_cardbrd_pickup
OR NOT HAS_MODEL_LOADED patriotb
	WAIT 0
ENDWHILE
...
//SET_ENTER_CAR_RANGE_MULTIPLIER 3.0 // REMOVED OPCODE

CREATE_CAR patriotb 7176.6 -7924.7 5.2 fake_plyr_car
SET_CAR_HEADING fake_plyr_car 259.7 
CREATE_PICKUP_WITH_AMMO remote PICKUP_ONCE 15 7191.4 -7924.1 6.2 grenades_pickup
...
//car1 at back
CREATE_CAR walton 7492.4 -8226.1 4.9 mexican_car
...
CREATE_OBJECT cj_cardbrd_pickup 7492.4 -8226.1 5.0 box1
SET_OBJECT_COLLISION box1 FALSE
CREATE_CHAR PEDTYPE_MISSION1 WMYCR 7492.4 -8226.1 5.0 mexican_gunner
...
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner TRUE TRUE TRUE
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner TRUE TRUE TRUE
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner TRUE TRUE TRUE
ATTACH_CHAR_TO_CAR mexican_gunner mexican_car 0.0 -1.0 0.9 FACING_BACK 45.0 82 

//car2
CREATE_CAR walton 7486.4 -8237.1 4.9 mexican_car2
...
CREATE_OBJECT cj_cardbrd_pickup 7486.4 -8237.1 5.0 box2
SET_OBJECT_COLLISION box2 FALSE

//car3
CREATE_CAR walton 7575.1 -7461.6 5.3 mexican_car3
...
CREATE_CHAR PEDTYPE_MISSION1 WMYCR 7575.1 -7461.6 5.3 mexican_gunner1
...
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner1 TRUE TRUE TRUE
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner1 TRUE TRUE TRUE
TASK_TOGGLE_PED_THREAT_SCANNER mexican_gunner1 TRUE TRUE TRUE
ATTACH_CHAR_TO_CAR mexican_gunner1 mexican_car3 0.0 -1.0 0.9 FACING_BACK 45.0 82 

CREATE_OBJECT cj_cardbrd_pickup 7575.1 -7461.6 5.3 box3
SET_OBJECT_COLLISION box3 FALSE

//car4
CREATE_CAR walton 7575.1 -7472.9 5.3 mexican_car4
...
CREATE_OBJECT cj_cardbrd_pickup 7575.1 -7472.9 5.3 box4
SET_OBJECT_COLLISION box4 FALSE

//impossible IF statement - IGNORE
IF flag_player_on_mission = 0
	CREATE_CAR faggio 7406.0 -8575.0 5.0 press_moped1  
	CREATE_CHAR_INSIDE_CAR press_moped1 PEDTYPE_CIVMALE WMYCR press_driver1
	CREATE_CAR faggio 7406.0 -8575.0 5.0 press_moped2  
	CREATE_CHAR_INSIDE_CAR press_moped2 PEDTYPE_CIVMALE WMYCR press_driver2
	CREATE_CAR faggio 7406.0 -8575.0 5.0 press_moped3  
	CREATE_CHAR_INSIDE_CAR press_moped3 PEDTYPE_CIVMALE WMYCR press_driver3
	CREATE_CAR faggio 7406.0 -8575.0 5.0 press_moped4  
	CREATE_CHAR_INSIDE_CAR press_moped4 PEDTYPE_CIVMALE WMYCR press_driver4
ENDIF

/*
DISPLAY_ONSCREEN_COUNTER_WITH_STRING mexican_car_health COUNTER_DISPLAY_BAR PHI1_HP
DISPLAY_ONSCREEN_COUNTER_WITH_STRING mexican_car_health2 COUNTER_DISPLAY_BAR PHI1_HP
DISPLAY_ONSCREEN_COUNTER_WITH_STRING mexican_car_health3 COUNTER_DISPLAY_BAR PHI1_HP
DISPLAY_ONSCREEN_COUNTER_WITH_STRING mexican_car_health4 COUNTER_DISPLAY_NUMBER PHI1_HP
*/
...
IF gun_runner_goals = 0
	...
	IF NOT IS_CAR_DEAD mexican_car
		...
		IF create_gun1 = 2						 
			...
			OR IS_CHAR_IN_CAR scplayer mexican_car
		...
		IF mexican_car_health < 300
			IF NOT IS_CHAR_DEAD mexican_gunner
				...
				IF gunner_attack = 0
					TASK_KILL_CHAR_ON_FOOT mexican_gunner scplayer
					gunner_attack = 1
				ENDIF 
			ENDIF
			IF NOT IS_CHAR_DEAD mexican_driver
				IF IS_CHAR_IN_CAR mexican_driver mexican_car  
					TASK_LEAVE_CAR_IMMEDIATELY mexican_driver mexican_car
				ENDIF
			ENDIF
		ENDIF   
	ELSE
	...
	IF NOT IS_CAR_DEAD mexican_car2
		...
		IF create_gun2 = 2
			...
			OR IS_CHAR_IN_CAR scplayer mexican_car2 
		...
		IF mexican_car_health2 < 300
			IF NOT IS_CHAR_DEAD mexican_driver2
				IF IS_CHAR_IN_CAR mexican_driver2 mexican_car2  
					TASK_LEAVE_CAR_IMMEDIATELY mexican_driver2 mexican_car2
				ENDIF
			ENDIF
		ENDIF   
	ELSE
	...
	IF NOT IS_CAR_DEAD mexican_car3
		...
		IF create_gun3 = 2
			...
			OR IS_CHAR_IN_CAR scplayer mexican_car3 
		...
		IF mexican_car_health3 < 300
			IF NOT IS_CHAR_DEAD mexican_gunner1
				...
				IF gunner1_attack = 0
					TASK_KILL_CHAR_ON_FOOT mexican_gunner1 scplayer
					gunner1_attack = 1
				ENDIF
			ENDIF 
			IF NOT IS_CHAR_DEAD mexican_driver3
				IF IS_CHAR_IN_CAR mexican_driver3 mexican_car3  
					TASK_LEAVE_CAR_IMMEDIATELY mexican_driver3 mexican_car3
				ENDIF
			ENDIF
		ENDIF   
	ELSE
	...
	IF NOT IS_CAR_DEAD mexican_car4
		...
		IF create_gun4 = 2
			...
			OR IS_CHAR_IN_CAR scplayer mexican_car4 
		...
		IF mexican_car_health4 < 300
			IF NOT IS_CHAR_DEAD mexican_driver4
				IF IS_CHAR_IN_CAR mexican_driver4 mexican_car4  
					TASK_LEAVE_CAR_IMMEDIATELY mexican_driver4 mexican_car4
				ENDIF
			ENDIF
		ENDIF   
	ELSE
...
//removing cars blips if the player1 is in them
	IF weapon_dropped = 0
		IF NOT IS_CAR_DEAD mexican_car 
			IF IS_CHAR_IN_CAR scplayer mexican_car
				REMOVE_BLIP mexican_car_blip
			ELSE
				IF gun1_collected = 0
					IF no_car_blip1 = 0
		...
		ENDIF
		IF NOT IS_CAR_DEAD mexican_car2 
			IF IS_CHAR_IN_CAR scplayer mexican_car2
				REMOVE_BLIP mexican_car2_blip
			ELSE
				IF gun2_collected = 0
					IF no_car_blip2 = 0
		...
		ENDIF
		IF NOT IS_CAR_DEAD mexican_car3 
			IF IS_CHAR_IN_CAR scplayer mexican_car3
				REMOVE_BLIP mexican_car3_blip
			ELSE
				IF gun3_collected = 0
					IF no_car_blip3 = 0
		...
		ENDIF
		IF NOT IS_CAR_DEAD mexican_car4 
			IF IS_CHAR_IN_CAR scplayer mexican_car4
				REMOVE_BLIP mexican_car4_blip
			ELSE
				IF gun4_collected = 0
					IF no_car_blip4 = 0
...
IF NOT IS_CAR_DEAD mexican_car
	IF NOT IS_CHAR_DEAD mexican_driver 
		...
		ELSE
			TASK_KILL_CHAR_ON_FOOT mexican_driver scplayer
		ENDIF
	ENDIF
ENDIF
...
IF NOT IS_CAR_DEAD mexican_car2
	IF NOT IS_CHAR_DEAD mexican_driver2 
		...
		ELSE
			TASK_KILL_CHAR_ON_FOOT mexican_driver2 scplayer
	    ENDIF
	ENDIF
ENDIF 
...
IF NOT IS_CAR_DEAD mexican_car3
	IF NOT IS_CHAR_DEAD mexican_driver3 
		...
		ELSE
			TASK_KILL_CHAR_ON_FOOT mexican_driver3 scplayer
		ENDIF
	ENDIF
ENDIF 
...
IF NOT IS_CAR_DEAD mexican_car4
	IF NOT IS_CHAR_DEAD mexican_driver4 
		...
		ELSE
			TASK_KILL_CHAR_ON_FOOT mexican_driver4 scplayer
		ENDIF	
	ENDIF		   
ENDIF 
...
//1st attacker
		IF NOT IS_CHAR_DEAD press_driver1 
				...
				IF IS_CHAR_IN_CAR press_driver1 press_moped1
					...
					IF IS_CHAR_IN_ANY_CAR scplayer 	
						...
						IF LOCATE_CAR_2D press_moped1 player_x player_y 12.0 12.0 FALSE 
							...
							TASK_LEAVE_CAR_IMMEDIATELY press_driver1 press_moped1
						ELSE
						...
						ENDIF
					ELSE
						IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver1 13.0 13.0 0
							TASK_KILL_CHAR_ON_FOOT press_driver1 scplayer
						ELSE
							SET_CAR_CRUISE_SPEED press_moped1 40.0
						ENDIF
					ENDIF
			...
			ELSE
				MARK_CAR_AS_NO_LONGER_NEEDED press_moped1
				IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver1 13.0 13.0 0
					press_driver1_off_moped = 1
					GOSUB steal_a_moped_1
				ENDIF
			ENDIF
...
//second attacker
		IF NOT IS_CHAR_DEAD press_driver2 
				...
				IF IS_CHAR_IN_CAR press_driver2 press_moped2
					...
					IF IS_CHAR_IN_ANY_CAR scplayer 	
						...
						IF LOCATE_CAR_2D press_moped2 player_x player_y 12.0 12.0 FALSE 
							...
							TASK_LEAVE_CAR_IMMEDIATELY press_driver2 press_moped2
						ELSE
						...
						ENDIF
					ELSE
						IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver2 13.0 13.0 0
							TASK_KILL_CHAR_ON_FOOT press_driver2 scplayer
						ELSE
							SET_CAR_CRUISE_SPEED press_moped2 40.0
						ENDIF
					ENDIF
			...
			ELSE 
				MARK_CAR_AS_NO_LONGER_NEEDED press_moped2
				IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver2 13.0 13.0 0
					press_driver2_off_moped = 1
					GOSUB steal_a_moped_2
				ENDIF
			ENDIF
...
//third attacker
		IF NOT IS_CHAR_DEAD press_driver3 
				...
				IF IS_CHAR_IN_CAR press_driver3 press_moped3
					...
					IF IS_CHAR_IN_ANY_CAR scplayer 	
						...
						IF LOCATE_CAR_2D press_moped3 player_x player_y 12.0 12.0 FALSE 
							...
							TASK_LEAVE_CAR_IMMEDIATELY press_driver3 press_moped3
						ELSE
						...
						ENDIF
					ELSE
						IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver3 13.0 13.0 0
							TASK_KILL_CHAR_ON_FOOT press_driver3 scplayer
						ELSE
							SET_CAR_CRUISE_SPEED press_moped3 40.0
						ENDIF
					ENDIF
			...
			ELSE 
				MARK_CAR_AS_NO_LONGER_NEEDED press_moped3
				IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver3 13.0 13.0 0
					press_driver3_off_moped = 1
					GOSUB steal_a_moped_3
				ENDIF	
			ENDIF
...
//fourth attacker
		IF NOT IS_CHAR_DEAD press_driver4 
				...
				IF IS_CHAR_IN_CAR press_driver4 press_moped4
					...
					IF IS_CHAR_IN_ANY_CAR scplayer 	
						...
						IF LOCATE_CAR_2D press_moped4 player_x player_y 12.0 12.0 FALSE 
							...
							TASK_LEAVE_CAR_IMMEDIATELY press_driver4 press_moped4
						ELSE
						...
						ENDIF
					ELSE
						IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver4 13.0 13.0 0
							TASK_KILL_CHAR_ON_FOOT press_driver4 scplayer
						ELSE
							SET_CAR_CRUISE_SPEED press_moped4 40.0
						ENDIF
					ENDIF
			...
			ELSE
				MARK_CAR_AS_NO_LONGER_NEEDED press_moped4
				IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver4 13.0 13.0 0
					press_driver4_off_moped = 1 
					GOSUB steal_a_moped_4
				ENDIF
			ENDIF
...
IF IS_CAR_DEAD mexican_car
	IF NOT IS_CHAR_DEAD mexican_gunner 
		DETACH_CHAR_FROM_CAR mexican_gunner
		//EXPLODE_CHAR_HEAD mexican_gunner // PULLED
	ENDIF
	REMOVE_BLIP mexican_car_blip
...
IF IS_CAR_DEAD mexican_car3
	IF NOT IS_CHAR_DEAD mexican_gunner1 
		DETACH_CHAR_FROM_CAR mexican_gunner1 
		//EXPLODE_CHAR_HEAD mexican_gunner1 // PULLED
	ENDIF
	REMOVE_BLIP mexican_car3_blip
...
IF NOT IS_CAR_DEAD mexican_car
	IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car 200.0 200.0 FALSE
...
IF NOT IS_CAR_DEAD mexican_car2
	IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car2 200.0 200.0 FALSE
...
IF NOT IS_CAR_DEAD mexican_car3
	IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car3 200.0 200.0 FALSE
...
IF NOT IS_CAR_DEAD mexican_car4
	IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car4 200.0 200.0 FALSE
...
/*
CLEAR_ONSCREEN_COUNTER mexican_car_health
CLEAR_ONSCREEN_COUNTER mexican_car_health2
CLEAR_ONSCREEN_COUNTER mexican_car_health3
CLEAR_ONSCREEN_COUNTER mexican_car_health4
*/
RETURN
...
MARK_MODEL_AS_NO_LONGER_NEEDED patriotb
...
IF weapon_knocked_from_back_of_truck_var = 1
	IF NOT IS_CHAR_DEAD mexican_driver_var 
		IF IS_CHAR_IN_CAR mexican_driver_var mexican_car_var
			...
			ENDIF
		ELSE
			TASK_KILL_CHAR_ON_FOOT mexican_driver_var scplayer
		ENDIF
	ENDIF
ENDIF

IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car_var 80.0 80.0 FALSE  
	...
	IF IS_CHAR_IN_CAR mexican_driver_var mexican_car_var 
		IF IS_CAR_DEAD mexican_car_var
			IF IS_CAR_IN_WATER mexican_car_var
				IF NOT LOCATE_CHAR_ANY_MEANS_CAR_2D scplayer mexican_car_var 50.0 50.0 0
					IF NOT IS_CAR_ON_SCREEN mexican_car_var
						GET_CAR_COORDINATES mexican_car_var mexican_car_x mexican_car_y mexican_car_z
						GET_CLOSEST_CAR_NODE_WITH_HEADING mexican_car_x mexican_car_y mexican_car_z mexican_car_x mexican_car_y mexican_car_z mex_warp_heading
...
IF flag_press1_moped_dead = 1
	MARK_CAR_AS_NO_LONGER_NEEDED press_moped1 
	MARK_CHAR_AS_NO_LONGER_NEEDED press_driver1 
	IF NOT IS_CHAR_IN_ZONE scplayer HAITI  
		CREATE_CAR faggio 7265.3 -8323.1 4.9 press_moped1  
	ELSE
		CREATE_CAR faggio 7570.5 -7597.4 4.9 press_moped1
	...
	GIVE_WEAPON_TO_CHAR press_driver1 82 30000
...
IF flag_press2_moped_dead = 1 
	...
	MARK_CHAR_AS_NO_LONGER_NEEDED press_driver2 
	IF NOT IS_CHAR_IN_ZONE scplayer HAITI  
		CREATE_CAR faggio 7265.3 -8328.1 4.9 press_moped2  
	ELSE
		CREATE_CAR faggio 7570.5 -7592.4 4.9 press_moped2
	...
	GIVE_WEAPON_TO_CHAR press_driver2 82 30000
...
IF flag_press3_moped_dead = 1 
	...
	MARK_CHAR_AS_NO_LONGER_NEEDED press_driver3 
	IF NOT IS_CHAR_IN_ZONE scplayer HAITI  
		CREATE_CAR faggio 7265.3 -8333.1 4.9 press_moped3  
	ELSE
		CREATE_CAR faggio 7570.5 -7587.4 4.9 press_moped3
	...
	GIVE_WEAPON_TO_CHAR press_driver3 82 30000
...
IF flag_press4_moped_dead = 1 
	...
	GIVE_WEAPON_TO_CHAR press_driver4 82 30000
...
IF press_driver1_off_moped = 1 
	IF NOT IS_CHAR_DEAD press_driver1 
		...
		IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver1 50.0 50.0 0
			IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver1 13.0 13.0 0
				...
				IF NOT press_moped1 = -1
					...
					SET_CAR_CRUISE_SPEED press_moped1 0.0
					TASK_ENTER_CAR_AS_DRIVER press_driver1 press_moped1 3000
...
IF press_driver2_off_moped = 1 
	IF NOT IS_CHAR_DEAD press_driver2 
		...
		IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver2 50.0 50.0 0
			IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver2 13.0 13.0 0 		
				mopedcoord_2_x = mopedcoord_1_x + 20.0
				mopedcoord_2_y = mopedcoord_1_y + 20.0
				mopedcoord_1_x = mopedcoord_1_x - 20.0
				...
				IF NOT press_moped2 = -1
					...
					SET_CAR_CRUISE_SPEED press_moped2 0.0
					TASK_ENTER_CAR_AS_DRIVER press_driver2 press_moped2 3000
...
IF press_driver3_off_moped = 1 
	IF NOT IS_CHAR_DEAD press_driver3 
		...
		IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver3 50.0 50.0 0
			IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver3 13.0 13.0 0 		
				mopedcoord_2_x = mopedcoord_1_x + 20.0
				mopedcoord_2_y = mopedcoord_1_y + 20.0
				mopedcoord_1_x = mopedcoord_1_x - 20.0
				...
				IF NOT press_moped3 = -1
					...
					SET_CAR_CRUISE_SPEED press_moped3 0.0
					TASK_ENTER_CAR_AS_DRIVER press_driver3 press_moped3 3000
...
IF press_driver4_off_moped = 1 
	IF NOT IS_CHAR_DEAD press_driver4 
		...
		IF LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver4 50.0 50.0 0
			IF NOT LOCATE_CHAR_ANY_MEANS_CHAR_2D scplayer press_driver4 13.0 13.0 0 		
				mopedcoord_2_x = mopedcoord_1_x + 20.0
				mopedcoord_2_y = mopedcoord_1_y + 20.0
				mopedcoord_1_x = mopedcoord_1_x - 20.0
				...
				IF NOT press_moped4 = -1
					...
					SET_CAR_CRUISE_SPEED press_moped4 0.0
					TASK_ENTER_CAR_AS_DRIVER press_driver4 press_moped4 3000
