...
LVAR_INT bs_empty_decisions

LVAR_INT bs_timer_diff bs_timer_end bs_timer_start

//speech
LVAR_INT bs_speech_goals bs_speech_control_flag bs_speech_flag bs_random_last_label 
LVAR_TEXT_LABEL bs_print_label[7] 
LVAR_INT bs_audio_label[7] 
LVAR_INT bs_last_label //bs_played_random_speech[2]   
LVAR_INT bs_slot1 bs_slot2 bs_slot_load bs_play_which_slot
...
COPY_CHAR_DECISION_MAKER DM_PED_EMPTY bs_empty_decisions
...
//bs_which_missions_are_open_flag = 16
///////////////////////////////////////////////////////////////
...
IF bs_scripted_cut = 0
	WHILE bs_scripted_cut = 0
		WAIT 0 
		...
		IF bs_control_flag = 0 
			...
			SET_CHAR_COORDINATES scplayer 1172.5480 1350.0630 9.9
			SET_CHAR_HEADING scplayer 180.0
			
			//creating a secretary
			REQUEST_MODEL WMYMECH
			LOAD_ALL_MODELS_NOW
			LVAR_INT bs_secretary
			CLEAR_AREA 1173.4 1348.4 10.9 30.0 TRUE 
			CREATE_CHAR PEDTYPE_MISSION1 WMYMECH 1173.4 1348.4 9.9 bs_secretary 
			SHUT_CHAR_UP_FOR_SCRIPTED_SPEECH bs_secretary TRUE 

			SET_CHAR_DECISION_MAKER bs_secretary bs_empty_decisions  

			SET_CHAR_HEADING bs_secretary 30.0
			SET_CHAR_NEVER_TARGETTED bs_secretary TRUE 
			SET_CHAR_KEEP_TASK bs_secretary TRUE
			TASK_STAND_STILL bs_secretary -2  
			
			SET_FIXED_CAMERA_POSITION 1172.8 1350.6 11.5 0.0 0.0 0.0  
			POINT_CAMERA_AT_POINT 1172.8 1347.6 11.4 JUMP_CUT

			//cutscene dialogue
			bs_speech_goals = 1
			bs_speech_control_flag = 0
			GOSUB bs_dialogue_setup 

			IF NOT IS_CHAR_DEAD bs_secretary 
				START_CHAR_FACIAL_TALK bs_secretary 20000
			ENDIF
		...
		IF bs_control_flag = 1 
			IF bs_speech_goals = 0
				SKIP_CUTSCENE_END
				IF NOT IS_CHAR_DEAD bs_secretary 
					STOP_CHAR_FACIAL_TALK bs_secretary
				ENDIF
				CLEAR_PRINTS
...
DO_FADE 500 FADE_IN
	...
	ENDWHILE
	*/
PRINT_NOW ( BS_X_1 ) 3000 4 //Walk into the locate to access the television. 
...
bs_overall_dialogue:///////////////////////////////////////////////////////////////////////
IF bs_speech_goals = 1 //cutscene dialogue
	IF bs_speech_control_flag < bs_last_label
		GOSUB bs_loading_dialogue
		GOSUB bs_playing_dialogue
		GOSUB bs_finishing_dialogue  
	ELSE
		IF NOT IS_CHAR_DEAD bs_secretary 
			STOP_CHAR_FACIAL_TALK bs_secretary
		ENDIF
...
bs_dialogue_setup://////////////////////////////////////////////////////////
IF bs_speech_goals = 1
	$bs_print_label[0] = &MEC_B1 // Welcome to the Advanced Driving School
	$bs_print_label[1] = &MEC_B2 // To pass you must score BRONZE or higher in all 11 tests.		
	$bs_print_label[2] = &MEC_B3 // To view a demonstration of each test, please use the TV over there.
	$bs_print_label[3] = &MEC_B4 // Passing a test will unlock the next test in the training program.
	$bs_print_label[4] = &MEC_B5 // You can come back and check your scores or take new tests at any time.

	bs_audio_label[0] = SOUND_MEC_B1 
	bs_audio_label[1] = SOUND_MEC_B2 
	bs_audio_label[2] = SOUND_MEC_D3 
	bs_audio_label[3] = SOUND_MEC_D4 
	bs_audio_label[4] = SOUND_MEC_D5 
	bs_last_label = 5
ENDIF

bs_slot_load = bs_speech_control_flag
bs_slot1 = 0
bs_slot2 = 0
bs_play_which_slot = 1
RETURN/////////////////////////////////////////////////////////////////////////////////////


bs_loading_dialogue:////////////////////////////////////////////////////////
IF bs_slot_load < bs_last_label 
	//slot 1
	IF bs_slot1 = 0
		LOAD_MISSION_AUDIO 1 bs_audio_label[bs_slot_load] 
		bs_slot_load ++ 
		bs_slot1 = 1
	ENDIF
	...
	//slot 2		    
	IF bs_slot2 = 0
		LOAD_MISSION_AUDIO 2 bs_audio_label[bs_slot_load] 
		bs_slot_load ++ 
		bs_slot2 = 1
	ENDIF
ENDIF
...
bs_playing_dialogue:////////////////////////////////////////////////////////
//slot 1
IF bs_play_which_slot = 1 
	IF bs_slot1 = 1
		IF HAS_MISSION_AUDIO_LOADED 1	 
			PLAY_MISSION_AUDIO 1
			PRINT_NOW ( $bs_print_label[bs_speech_control_flag] ) 4500 1 
			bs_slot1 = 2
		ENDIF
	ENDIF
ENDIF
...
bs_finishing_dialogue://////////////////////////////////////////////////////
//slot 1
IF bs_slot1 = 2
	IF HAS_MISSION_AUDIO_FINISHED 1
		CLEAR_THIS_PRINT $bs_print_label[bs_speech_control_flag]
		bs_speech_control_flag ++		
		bs_play_which_slot = 2
		bs_slot1 = 0
	ENDIF
ENDIF
