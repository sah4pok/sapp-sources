...
//REQUEST_COLLISION 1500.02 -1656.27
//LOAD_SCENE 1500.02 -1656.27 14.10
...
//Mi Downtown (BMX Track)
//REQUEST_COLLISION 7824.388 -6843.12
//LOAD_SCENE 7824.388 -6843.12 4.8  
//CREATE_PLAYER 0 7824.388 -6843.12 4.8 player1 

//Mi Downtown 2 (near to Test Track)
//REQUEST_COLLISION 7958.2240 -6951.2340
//LOAD_SCENE 7958.2240 -6951.2340 6.7241
//CREATE_PLAYER 0 7958.2240 -6951.2340 6.7241 player1

//NY Ammunation 2
//REQUEST_COLLISION 8263.182 8282.358
//LOAD_SCENE 8263.182 8282.358 26.399 
//CREATE_PLAYER 0 8263.182 8282.358 26.399 player1 
...
GOTO skip_create_player2
	...
	//CREATE_PLAYER 1 1500.02 -1656.27 14.10 player2
	//CREATE_PLAYER 1 7958.2240 -6951.2340 6.7241  player2
skip_create_player2:
...
//LOAD_AND_LAUNCH_MISSION main.sc // San Andreas
//wait 0
//LOAD_AND_LAUNCH_MISSION main2.sc // Vice City
//wait 0
//LOAD_AND_LAUNCH_MISSION main3.sc // Liberty City
//wait 0
LOAD_AND_LAUNCH_MISSION initial.sc // San Andreas
wait 0
LOAD_AND_LAUNCH_MISSION initial2.sc
wait 0
//LOAD_AND_LAUNCH_MISSION initial3.sc // Vice City
//wait 0
//LOAD_AND_LAUNCH_MISSION initial4.sc // Liberty City
...
VAR_INT bmx_1_trigger bmx_2_trigger  
...
GOTO dont_run_the_blips
	...
	//ADD_SPRITE_BLIP_FOR_CONTACT_POINT philX philY philZ 66 phil_contact_blip
	...
	//ADD_SHORT_RANGE_SPRITE_BLIP_FOR_CONTACT_POINT philX philY philZ 66 phil_contact_blip
...
//REGISTER_STREAMED_SCRIPT porta_cabin.sc
...
//REGISTER_STREAMED_SCRIPT ammu3.sc
...
//ALLOCATE_STREAMED_SCRIPT_TO_OBJECT porta_cabin.sc cardboardbox2 100 70.0 -1
//ALLOCATE_STREAMED_SCRIPT_TO_OBJECT porta_cabin.sc cardboardbox4 100 70.0 -1
//ALLOCATE_STREAMED_SCRIPT_TO_OBJECT porta_cabin.sc cardboardbox 100 70.0 -1
...
//LAUNCH_MISSION Ext_Manager.sc //CC
...
//LAUNCH_MISSION ammu2.sc
//LAUNCH_MISSION ammu_stock.sc
//LAUNCH_MISSION interiors.sc
//LAUNCH_MISSION robbing.sc


//DO_FADE 0 FADE_OUT //FOR FINAL BUILD!!!!!!!!!!!!!!!!!
...
IF IS_PLAYER_PLAYING player1
	...
	//LAUNCH_MISSION designtools.sc 

	//FOR FINAL BUILD!!!!!!!!!!!!!!!!!
	SET_FADING_COLOUR 0 0  0  
	DO_FADE 0 FADE_OUT
	game_starts_from_scratch = 0
	//LOAD_AND_LAUNCH_MISSION intro_vice.sc
	LOAD_AND_LAUNCH_MISSION intro.sc
	//LOAD_AND_LAUNCH_MISSION bikesch.sc
	//START_NEW_SCRIPT bikes_school_loop // DEBUG
	...
	IF IS_PLAYER_PLAYING player1
		IF flag_player_on_mission = 0
			IF CAN_PLAYER_START_MISSION player1
				IF LOCATE_CHAR_ON_FOOT_3D scplayer philX philY philZ 1.2 1.2 2.0 FALSE
					IF flag_phil_mission_counter = 0
						flag_player_on_mission = 1
...
WAIT mission_trigger_wait_time
    ...
    IF flag_player_on_mission = 0
		  IF IS_CHAR_IN_MODEL scplayer pcj600
        	IF NOT LOCATE_CHAR_ANY_MEANS_3D scplayer 8758.6140 -8556.7850 8.3775 3.0 3.0 3.0 FALSE //VC
				flag_4x4one_trigger = 1
				ENDIF
			ENDIF
				//IF CAN_PLAYER_START_MISSION player1
				IF IS_CHAR_IN_MODEL scplayer pcj600
					IF flag_4x4one_trigger = 0
				//		get_int_stat BIKE_SKILL	stat
				//		IF stat > 199
				//		IF flag_4x4one_trigger = 0
							PRINT_BIG ( STAD_01 ) 1000 2//Dirt Track
							GOSUB mini_fade
							LOAD_AND_LAUNCH_MISSION miami_4x4_1.sc
							flag_4x4one_trigger = 1
						//ELSE
						ENDIF
							//print_now STATBIK 500 1 // Your bike skill is not high enough to enter this race.
...
SCRIPT_NAME o4x4_1 
	...
	IF IS_PLAYER_PLAYING player1
		...
		IF flag_player_on_mission = 0
		AND IS_PLAYER_IN_INFO_ZONE player1 BEACH3
						
			IF IS_CHAR_IN_MODEL scplayer pcj600
			AND NOT IS_CHAR_IN_AREA_3D scplayer 8758.6140 -8556.7850 8.3775 8760.4330 -8567.3070 10.3775 false
				flag_4x4one_trigger = 1
			ENDIF
...
carpark2_loop_inner:
	...
	IF IS_PLAYER_PLAYING player1
		...
		IF flag_player_on_mission = 0
		//AND IS_PLAYER_IN_INFO_ZONE scplayer COM_EAS

			IF IS_CHAR_IN_MODEL scplayer STALLION
			AND NOT IS_CHAR_IN_AREA_3D scplayer 125.0 -1155.0 27.0 130.0 -1160.0 33.0 false
    ...
    IF flag_player_on_mission = 0
		IF IS_CHAR_IN_ANY_CAR scplayer
			...
			IF IS_CHAR_IN_MODEL scplayer pcj600 
				IF flag_4x4one_trigger = 0
				CLEAR_PRINTS
				get_int_stat BIKE_SKILL	stat_read_skill_temp
		...
		ENDIF
			...
			IF IS_CHAR_IN_MODEL scplayer sanchez
				IF NOT LOCATE_CHAR_ANY_MEANS_3D scplayer 7824.388 -6843.12 4.8 3.0 3.0 3.0 FALSE //VC
				//AND IS_PLAYER_IN_INFO_ZONE player1 BEACH3
			        bmx_1_trigger = 1
				ENDIF
			ENDIF
			...
			IF IS_CHAR_IN_MODEL scplayer sanchez
				...
				CLEAR_PRINTS
				get_int_stat BIKE_SKILL	stat_read_skill_temp
				IF stat_read_skill_temp >= 100   // skill has to be over 100
				//IF stat_read_skill_temp >= 0   // TEST!!!!!!!!!!
			        PRINT_BIG ( COUR1 ) 1000 2 //COURIER MISSION LV
					LOAD_AND_LAUNCH_MISSION bmx_1.sc
					bmx_1_trigger = 1               
				ELSE 
					IF flag_cycling_skill_help = 0
						print_now STATBIK 500 1 // Your bike skill is not high enough to enter this race.
		...
		ENDIF
			...
			// ************************************Test Track (Downtown)*******************************************************************
			IF IS_CHAR_IN_MODEL scplayer landstal
				IF NOT LOCATE_CHAR_ANY_MEANS_3D scplayer 7824.0 -6837.5 5.5 3.0 3.0 3.0 FALSE //VC
				//AND IS_PLAYER_IN_INFO_ZONE player1 BEACH3
			        bmx_2_trigger = 1
				ENDIF
			ENDIF
			...
			IF IS_CHAR_IN_MODEL scplayer landstal
				IF bmx_2_trigger = 0
				CLEAR_PRINTS
				get_int_stat DRIVING_SKILL	stat_read_skill_temp
				IF stat_read_skill_temp >= 200   // skill has to be over 200
				//IF stat_read_skill_temp >= 0   // TEST!!!!!!!!!!
			        PRINT_BIG ( COUR1 ) 1000 2 //COURIER MISSION LV
					LOAD_AND_LAUNCH_MISSION bmx_2.sc
					bmx_2_trigger = 1               
				ELSE 
					print_now STATCAR 500 1 // Your driving skill is not high enough to enter this race.
				ENDIF
...
save_the_game:
	...
	IF IS_PLAYER_PLAYING player1
		//SET_PLAYER_HEALTH player1 200 // RESTORED LINE
		SET_PLAYER_CONTROL player1 OFF
	ENDIF
