...
porta_cabin_loop:
	...
	// load peds inside undamaged PORTAKABIN if player gets near
	IF IS_PLAYER_PLAYING player1
		...
		IF damage_state = 0
			...
			IF flag = 1
				...
				REQUEST_MODEL PORTAKABIN // sectionA
				REQUEST_MODEL PORTAKABIN // sectionB
				REQUEST_MODEL PORTAKABIN // sectionC
				REQUEST_MODEL bmycon 
				WHILE NOT HAS_MODEL_LOADED PORTAKABIN  // sectionA
				   OR NOT HAS_MODEL_LOADED PORTAKABIN  // sectionB
				   OR NOT HAS_MODEL_LOADED PORTAKABIN  // sectionC 
				...
				IF DOES_OBJECT_EXIST section[0]
					...
					CREATE_CHAR PEDTYPE_CIVMALE bmycon x y z ped[0]
