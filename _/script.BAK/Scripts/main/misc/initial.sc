...
VAR_INT bs_which_missions_are_open_flag
bs_which_missions_are_open_flag = 1
...
VAR_INT ammu_shop_blip[10] mod_garage_blips[3] barbers_blips[6] pizza_blips[8] burger_blips[10] chicken_blips[12] tattoo_blips[4] gym_blips[2] clothes_blips[17] spray_shop[7]
...
ADD_SHORT_RANGE_SPRITE_BLIP_FOR_COORD 2393.779 1481.181 12.551 RADAR_SPRITE_SPRAY spray_shop[6] //East Vegas
...
// MIAMI
ADD_HOSPITAL_RESTART 8141.7 -9224.4 4.4 283.9 0 // Little Havana // (south)
ADD_POLICE_RESTART 8648.8 -8719.7 5.7 323.0 0  // Downtown // (south)

ADD_HOSPITAL_RESTART 8743.5 -7546.9 6.1 90.0 1 // Vice Point // (north)
ADD_POLICE_RESTART 8758.9 -7743.2 5.3 174.0 1 // Washington Beach // (north)
...
// ******************************************MIAMI PEDS ****************************************************
		...
		// 
		SET_ZONE_POPULATION_TYPE STREET4 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE RICH2 POPCYCLE_ZONE_RESIDENTIAL_RICH
		SET_ZONE_POPULATION_TYPE CLUB2 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE	
		SET_ZONE_POPULATION_TYPE SHOP3 POPCYCLE_ZONE_SHOPPING
		SET_ZONE_POPULATION_TYPE STREET3 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE SHOP2 POPCYCLE_ZONE_SHOPPING

		// Beach
		SET_ZONE_POPULATION_TYPE OCEAND1 POPCYCLE_ZONE_BEACH
		SET_ZONE_POPULATION_TYPE OCEAND2 POPCYCLE_ZONE_BEACH
		SET_ZONE_POPULATION_TYPE BEACH1 POPCYCLE_ZONE_BEACH
		SET_ZONE_POPULATION_TYPE BEACH2 POPCYCLE_ZONE_BEACH
		SET_ZONE_POPULATION_TYPE BEACH3 POPCYCLE_ZONE_BEACH
		SET_ZONE_POPULATION_TYPE STREET2 POPCYCLE_ZONE_BEACH

		// Golf Club		
		SET_ZONE_POPULATION_TYPE GOLF1 POPCYCLE_ZONE_GOLF_CLUB
		SET_ZONE_POPULATION_TYPE GOLF2 POPCYCLE_ZONE_GOLF_CLUB
		
		//
		SET_ZONE_POPULATION_TYPE STREET1 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE RICH1 POPCYCLE_ZONE_RESIDENTIAL_RICH
		SET_ZONE_POPULATION_TYPE SHOP1 POPCYCLE_ZONE_SHOPPING
		SET_ZONE_POPULATION_TYPE TOUR1 POPCYCLE_ZONE_PARK
		SET_ZONE_POPULATION_TYPE TOUR2 POPCYCLE_ZONE_PARK

		// Escobar International Airport
		SET_ZONE_POPULATION_TYPE AIRPORT POPCYCLE_ZONE_AIRPORT
		SET_ZONE_POPULATION_TYPE TERMINL POPCYCLE_ZONE_AIRPORT
		SET_ZONE_POPULATION_TYPE BAGGAG POPCYCLE_ZONE_AIRPORT_RUNWAY

		//
		SET_ZONE_POPULATION_TYPE DOCKS POPCYCLE_ZONE_INDUSTRY
		SET_ZONE_POPULATION_TYPE STREET6 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE STREET5 POPCYCLE_ZONE_RESIDENTIAL_AVERAGE

		// Downtown			
		SET_ZONE_POPULATION_TYPE SHOP4 POPCYCLE_ZONE_SHOPPING_POSH
		SET_ZONE_POPULATION_TYPE SHOP5 POPCYCLE_ZONE_SHOPPING_POSH
		SET_ZONE_POPULATION_TYPE BUSINES POPCYCLE_ZONE_BUSINESS
		SET_ZONE_POPULATION_TYPE TESTT POPCYCLE_ZONE_BUSINESS
		SET_ZONE_POPULATION_TYPE BIKA POPCYCLE_ZONE_BUSINESS
		
		// Little Haiti
		// Aspiring blue collar workers mingle with young urban professionals starting out.
		// Gang here: GANG_FLAT	(Glan 1 and 4 only)
		SET_ZONE_POPULATION_TYPE GANG1 POPCYCLE_ZONE_GANGLAND
		SET_ZONE_POPULATION_TYPE GANG2 POPCYCLE_ZONE_GANGLAND
		SET_ZONE_POPULATION_TYPE GHETTO1 POPCYCLE_ZONE_GANGLAND
		SET_ZONE_POPULATION_TYPE GHETTO2 POPCYCLE_ZONE_GANGLAND
		SET_ZONE_POPULATION_TYPE KAUFCAB POPCYCLE_ZONE_GANGLAND
		SET_ZONE_POPULATION_TYPE PRINTWK POPCYCLE_ZONE_GANGLAND

		SET_ZONE_GANG_STRENGTH GANG1 1 40 //Jamaicans
		SET_ZONE_GANG_STRENGTH GANG2 1 40 //Jamaicans
		SET_ZONE_GANG_STRENGTH GHETTO1 2 40 //Latins
		SET_ZONE_GANG_STRENGTH GHETTO2 2 40 //Latins
		SET_ZONE_GANG_STRENGTH KAUFCAB 3 40 //Haitians
		SET_ZONE_GANG_STRENGTH PRINTWK 3 40 //Haitians
		
		SET_ZONE_DEALER_STRENGTH GANG1 4 
		SET_ZONE_DEALER_STRENGTH GANG2 4 
		SET_ZONE_DEALER_STRENGTH GHETTO1 2
		SET_ZONE_DEALER_STRENGTH GHETTO2 2
		SET_ZONE_DEALER_STRENGTH KAUFCAB 2
		SET_ZONE_DEALER_STRENGTH PRINTWK 2

		SET_ZONE_POPULATION_TYPE CARYRD POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE PORNSTU POPCYCLE_ZONE_RESIDENTIAL_AVERAGE
		SET_ZONE_POPULATION_TYPE ARMYBAS POPCYCLE_ZONE_AIRPORT
