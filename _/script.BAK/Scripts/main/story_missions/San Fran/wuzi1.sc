...
wz1_initialise_stuff:
	...
	OR NOT HAS_MODEL_LOADED SENTINELB
...
//			SET_USES_COLLISION_OF_CLOSEST_OBJECT_OF_TYPE -2175.2129 662.7180 50.8582 10.5 china_town_gateb FALSE
		...
		REQUEST_CAR_RECORDING 169
			...
			CREATE_CAR SENTXS -2183.5747 705.0761 52.8984 wz1_burncar2
			CREATE_CAR SENTXS -2174.4292 703.2332 52.8918 wz1_burncar1 
...
//	ENDIF
	...
	IF wz1_cut_flag = 6
		IF audio_flag = 1
			IF play_audio = 0		
				...
				AND HAS_CAR_RECORDING_BEEN_LOADED 138
					...
					CREATE_CAR SENTINELB -2245.3433 715.4953 48.4375 wz1_carattack[0] 
		...
		//					TASK_TOGGLE_PED_THREAT_SCANNER wz1_tong[15] 1 1 1
					...
					CREATE_CAR SENTINELB -2251.6763 612.6026 42.2590 wz1_carattack[1]
...
//	SET_PLAYER_GROUP_TO_FOLLOW_ALWAYS player1 FALSE
	...
	MARK_MODEL_AS_NO_LONGER_NEEDED SNIPER
	MARK_MODEL_AS_NO_LONGER_NEEDED SENTINEL
	MARK_MODEL_AS_NO_LONGER_NEEDED SENTINELB
