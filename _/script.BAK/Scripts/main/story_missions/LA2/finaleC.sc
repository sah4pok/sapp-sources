		...
		IF NOT IS_CAR_DEAD firetruck_fc
			...
			IF rails_fcflag = 1
				IF LOCATE_CAR_2D firetruck_fc 2849.39 -1232.93 20.0 20.0 FALSE
					...
					ENDIF
					actiontext_fcflag = 1
					CREATE_CAR LOCO 2735.333 -1081.0465 69.033 ecar1_fc
					...
					CREATE_CAR LOCO 2595.742 -1003.581 75.038 ecar2_fc
			...
			IF rails_fcflag = 2
				IF LOCATE_CAR_2D benz_fc 2717.71 -1047.36 20.0 20.0 FALSE
					...
					CREATE_CAR LOCO 2707.499 -1329.559 47.3 mexcar1_fc
					...
					CREATE_CAR LOCO 2759.875 -1373.294 38.777 mexcar2_fc
			...
			IF rails_fcflag = 5
				IF LOCATE_CAR_2D firetruck_fc 2642.71 -1570.03 20.0 20.0 FALSE
					...
					CREATE_CAR LOCO 2704.0 -1654.0 10.0 mexcar3_fc
			...
			IF rioters_fcflag = 1
				IF LOCATE_CAR_2D firetruck_fc 2835.29 -1049.49 20.0 20.0 FALSE
					...
					CREATE_CAR LOCO 2785.06 -1043.915 35.916 parkedcar_fc
			...
			IF rioters_fcflag = 4
				IF LOCATE_CAR_2D benz_fc 2682.55 -1494.04 20.0 20.0 FALSE
					...
					CREATE_CAR LOCO 2638.9883 -1555.9426 18.9832 parkedcar_fc
...
//				DELETE_CHAR copladder_fc
	...
	IF finalcut_fcflag = 10
		IF TIMERA > 3000
			...
			MARK_MODEL_AS_NO_LONGER_NEEDED MOLOTOV
			MARK_MODEL_AS_NO_LONGER_NEEDED LSV3
			MARK_MODEL_AS_NO_LONGER_NEEDED LOCO
