...
ryder2_m_stage_1:
		...
		IF m_goals = 1
			...
			CREATE_OBJECT_NO_OFFSET WAREHOUSE_DOOR2B 2774.361 -2493.922 14.675 gate4_1	 // far
...
//					CLEAR_MISSION_AUDIO 2
	...
	IF m_goals = 7
		...
		//IF TIMERA > 6000			
			...
			GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS gate4_1 0.0 0.0 4.0 gate1_target_x	gate1_target_y gate1_target_z
			GET_OFFSET_FROM_OBJECT_IN_WORLD_COORDS gate7 0.0 0.0 4.0 gate2_target_x	gate2_target_y gate2_target_z

			IF DOES_OBJECT_EXIST gate4_1
				REPORT_MISSION_AUDIO_EVENT_AT_OBJECT gate4_1 SOUND_SHUTTER_DOOR_START
			ENDIF
	...
	IF m_goals = 8
		// open doors
		IF TIMERA > 1000 
			IF  SLIDE_OBJECT gate4_1 gate1_target_x gate1_target_y gate1_target_z 0.0 0.0 0.2 FALSE
			AND SLIDE_OBJECT gate7 gate2_target_x gate2_target_y gate2_target_z 0.0 0.0 0.15 FALSE
				IF DOES_OBJECT_EXIST gate4_1
					REPORT_MISSION_AUDIO_EVENT_AT_OBJECT gate4_1 SOUND_SHUTTER_DOOR_STOP
				ENDIF
				m_goals++
			ENDIF
		ENDIF
...
mission_cleanup_RYDER2:
	...
	MARK_OBJECT_AS_NO_LONGER_NEEDED	gate4_1
